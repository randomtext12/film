...
interface FourthPhaseProps {
  winnersFromThirdPhase: Record<number, Movie>;
...
export const FourthPhase: React.FC<FourthPhaseProps> = ({
  winnersFromThirdPhase,
  ...
  return !roundEnded ? (
    ...
    <FifthPhase
      winnersFromFourthPhase={winners}
